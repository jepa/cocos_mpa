...
lapply(spp_list$taxon_key[1], spp_trend_scen_fig, data = dbem_runs, data_path = data_path)
...
lapply(spp_list$taxon_key[1], spp_trend_status_fig, data = dbem_runs, data_path = data_path)
