...
scen_grid <- 
  bind_rows(
  read.csv("../data/mpa_scenario/scenario1.csv") %>% mutate(scen = "S1"),
  read.csv("../data/mpa_scenario/scenario2.csv") %>%  mutate(scen = "S2"),
  read.csv("../data/mpa_scenario/scenario3.csv") %>% mutate(scen = "S3")
  ) %>% 
...
write_csv(dbem_runs_c,"~/Library/CloudStorage/OneDrive-UBC/Data/dbem/results/dbem_runs_catch.csv")
...
write_csv(dbem_runs_a,"~/Library/CloudStorage/OneDrive-UBC/Data/cocos_mpa/results/dbem_runs_abd.csv")
