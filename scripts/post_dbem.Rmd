...
lapply(spp_list$taxon_key, spp_trend_scen_fig, data = dbem_runs, data_path = data_path)
...
lapply(spp_list$taxon_key, spp_trend_status_fig, data = dbem_runs, data_path = data_path)

```
## Delta map

```{r}
lapply(spp_list$taxon_key, spp_map_scen_delta, data = dbem_runs, data_path = data_path)
...
lapply(spp_list$taxon_key, spp_box_delta_status, data = dbem_runs, data_path = data_path)
