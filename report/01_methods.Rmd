...
Thus, for example, if status = protected, prop = 0 while if status = unprotected then prop = 1. Moreover, if there are 4 cells surrounding the a protected one cell, then prop = 1.25, if there are 2 surrounding cells then prop = 1.5,if there are 10 surrounding cells then prop = 1.1.
