...
- Spatial scale 
- Fishing effort is redistributed proportionally, in reality, it is possible that such effort is not proportionally distributed around the no-take MPA but rather localized in some areas, or not re-distributed at all. Other modelling exercises that incorporate different mechanisms in which fishing effort is re-allocated around a no-take MPA could help illuminate how social and economic factors related to fishing may affect the contribution of MPAs under climate change. 
