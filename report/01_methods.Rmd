...
To reallocate fishing in the DBEM from protected grids to surrounding [@Palacios-Adrbates.20237b], we took the *area protected* and divided by the *total area* of each grid cell that contain any protection. We then reallocate that protected area proportion to the surrounding cells in form of fishing effort (*F*):
