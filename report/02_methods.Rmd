...
The difference between scenarios is substantial in terms of biomass by the mid of the $21^{st}$ century (Figure \@ref(fig:deltabox)). Here, Scenario S1 will loose significantly less biomass than scenarios S2 and S3 who present no significan difference between them. This pattern is the same for both SSPs as is to be expected since SSP trajectories do not vary much before 2050.
